...
4.  **Analyze Comments:**
    ...
    *   Include some motivational comments for the videos. Provide a list of 5 motivational comments. These comments should be channel agnostic and not mention the channel name. These comments must be obtained from the response of the `get_comments` tool and must not be generated by you.
